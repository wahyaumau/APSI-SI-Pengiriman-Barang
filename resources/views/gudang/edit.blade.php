...
<div class="container-fluid m-0 p-4">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Edit Gudang') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('gudang.update', $gudang) }} ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="nama_gudang" type="text" class="form-control{{ $errors->has('nama_gudang') ? ' is-invalid' : '' }}" name="nama_gudang" value="{{ $gudang->nama_gudang }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="alamat_gudang" type="text" class="form-control{{ $errors->has('alamat_gudang') ? ' is-invalid' : '' }}" name="alamat_gudang" value="{{ $gudang->alamat_gudang }}" required autofocus>
