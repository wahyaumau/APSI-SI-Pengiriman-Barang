...
<div class="container-fluid m-0 p-4">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Edit Supir') }}</div>
                <div class="card-body">
                    <form method="POST" action="{{ route('supir.update', $supir) }} " enctype="multipart/form-data">
                        @method('PATCH')
                        @csrf
                        <div class="form-group row">
                            <label for="nama_supir" class="col-md-2 col-form-label text-md-right">{{ __('Nama Supir') }}</label>
                            <div class="col-md-8">
                                <input id="nama_supir" type="text" class="form-control{{ $errors->has('nama_supir') ? ' is-invalid' : '' }}" name="nama_supir" value="{{ $supir->nama_supir }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="alamat_supir" type="text" class="form-control{{ $errors->has('alamat_supir') ? ' is-invalid' : '' }}" name="alamat_supir" value="{{ $supir->alamat_supir }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input id="sim" type="text" class="form-control{{ $errors->has('sim') ? ' is-invalid' : '' }}" name="sim" value="{{ $supir->sim }}" required autofocus>
                                @if ($errors->has('sim'))
                                <span class="invalid-feedback" role="alert">
